...
public:
    ...
    virtual void calcAndPublishStaticTransform(
...
public:
    ...
    void updateExtrinsicsCalibData(
    ...
    void FillImuData_LinearInterpolation(
    ...
    template < class T >
    void set_parameter(
      rs2::options sensor, rs2_option option, const std::string & module_name,
    ...
    void registerAutoExposureROIOption(
    ...
    rclcpp::Publisher < sensor_msgs::msg::Imu > ::SharedPtr > _imu_publishers;
    ...
    std::map < stream_index_pair,
    rclcpp::Publisher < Extrinsics > ::SharedPtr > _depth_to_other_extrinsics_publishers;
